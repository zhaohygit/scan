...
console.log(arr)
 var pdf_url = arr.split('?')[1];
 console.log('pppppppppppdddddddddddddddfffffffffff')
 console.log(pdf_url)
 pdf_url = pdf_url.replace(/%20/g, '');
  //  document.getElementById('ceshi').innerText = pdf_url;
 var url = pdf_url;//展示的pdf路径
 console.log(pdf_url)
